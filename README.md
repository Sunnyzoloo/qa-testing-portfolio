...
Manual testing project demonstrating test planning, test case design, bug reporting, and exploratory testing.

🔗 Repository: https://github.com/Sunnyzoloo/manual-testing-saucedemo  
...
Automated end-to-end testing of the SauceDemo application using Playwright and TypeScript.

🔗 Repository: https://github.com/Sunnyzoloo/playwright-e2e-saucedemo  
...
Automated REST API testing using Playwright.

🔗 Repository: https://github.com/Sunnyzoloo/playwright-api-testing-fakestore  
